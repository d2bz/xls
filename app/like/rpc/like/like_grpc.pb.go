...
func (c *likeClient) HotVideoIDList(ctx context.Context, in *HotVideoIDListRequest, opts ...grpc.CallOption) (*HotVideoIDListResponse, error) {
	out := new(HotVideoIDListResponse)
	err := c.cc.Invoke(ctx, "/like.Like/HotVideoIDList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LikeServer interface {
	...
	HotVideoIDList(context.Context, *HotVideoIDListRequest) (*HotVideoIDListResponse, error)
...
func (UnimplementedLikeServer) HotVideoIDList(context.Context, *HotVideoIDListRequest) (*HotVideoIDListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HotVideoIDList not implemented")
}
...
func _Like_HotVideoIDList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HotVideoIDListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LikeServer).HotVideoIDList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/like.Like/HotVideoIDList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LikeServer).HotVideoIDList(ctx, req.(*HotVideoIDListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Like_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HotVideoIDList",
			Handler:    _Like_HotVideoIDList_Handler,
		},
	},
